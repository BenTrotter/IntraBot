...
def simulation(individual):
    ...
    startDate = '2021-03-15 08:00:00' # Start date of the overall trading window.
    endDate = '2021-03-23 08:00:00' # End date of the overall trading window.
    ...
    pcSplit = 8 # The number of intervals to split the trading window into for PC
...
if __name__ == "__main__":
    trainingStart = "2020-03-20 08:00:00" # Put these dates into the simulation function!
    trainingEnd = "2021-03-23 08:00:00"
    unseenStart = "2021-03-23 08:00:00"
    unseenEnd = "2021-03-24 08:00:00"
    freeze_support()
    random.seed()
